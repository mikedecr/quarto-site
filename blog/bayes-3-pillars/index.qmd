...
- Posterior samples make it dead-simple to describe uncertainty in any post-estimation quantity you wish.^[
    ...
    You can program your own CLARIFY routine in like 7 lines of R code.
]
...
Of course, we can only ever observe unit $i$ receive a single value of $i$, so $\tau_{i}$ cannot be measured.
